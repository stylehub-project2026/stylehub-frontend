...
export const FOOTER_COLS = [
  ...
  { title: "Sell With Us", links: [["Sign Up", "/seller"], ["How It Works", "/seller-support"], ["Seller Support", "/seller-support]] },
...
export const PRODUCTS = [
  ...
  { id: 2, tab: "best", name: "Red Alfenat Hoodie Kids", brand: "Antika", category: "boys", type: "tops", price: "LE 920", oldPrice: "LE 1,800", img: "/red.jpg", imgs: ["/othe3.jpg"], colors: ["#e63946", "#fff"], sizes: ["6Y", "8Y", "10Y"], rating: 4.9, reviews: 20, desc: "Cozy fleece hoodie, perfect for kids." },
  { id: 3, tab: "best", gender: "men", name: "Cream Knitted Zipper", brand: "Antika", price: "LE 750", oldPrice: "LE 870", img: "/zip.jpg", imgs: ["/a1.jpg", "/a2.jpg"], colors: ["#c2c6c8ff"], sizes: ["XS", "S", "M", "L"], rating: 4.7, reviews: 56, desc: "Knitted quarter zipper perfect for women and men." },
  ...
  { id: 18, tab: "new", gender: "unisex", type: "tops", name: "The Nefertiti Hoodie", brand: "Antika", price: "LE 920", oldPrice: null, img: "/aob.jpg", imgs: ["/d1.jpg", "/d2.jpg"], colors: ["#3d3b3cff"], sizes: ["XS", "S", "M", "L"], rating: 4.8, reviews: 6, desc: "The Charcoal Nefertiti Hoodie, 90% cotton. Oversized fit - Unisex." },
  { id: 19, tab: "new", gender: "unisex", type: "tops", name: "Orange Oversized Tee", brand: "Antika", price: "LE 650", oldPrice: null, img: "/antsh.jpg", imgs: ["/e1.jpg", "/e2.jpg", "/e3.jpg"], colors: ["#d98036ff"], sizes: ["XS", "S", "M", "L"], rating: 4.5, reviews: 15, desc: "Antika orange oversized tee, 100% cotton." },
  ...
  { id: 8, tab: "trend", gender: "men", name: "Trouble Sweatpants", brand: "27", price: "LE 690", oldPrice: "LE 900", img: "/29.jpg", img3d: "/27no.jpg", colors: ["#473635ff"], sizes: ["XS", "S", "M", "L"], rating: 4.8, reviews: 62, desc: "Navy edition, tailored fit." },
  ...
  { id: 44, tab: "sale", name: "Authentic Babytee", gender: "women", brand: "Salty", type: "tops", price: "LE 300", oldPrice: "LE 500", img: "/44.jpg", imgs: ["/chart2.jpg"], colors: ["#1a1a18", "#4a4a48"], sizes: ["S", "M", "L", "XL"], rating: 4.5, reviews: 167, desc: "Authentic cotton babytee." },
  { id: 45, gender: "men", name: "Culture Tshirt", brand: "Salty", type: "tops", price: "LE 400", oldPrice: "LE 500", img: "/45.jpg", colors: ["#392420ff", "#4a4a48"], sizes: ["S", "M", "L", "XL"], rating: 4.5, reviews: 167, desc: "The Culture T-Shirt represents the mindset behind Salty." },
  ...
  { id: 47, tab: "sale", gender: "men", name: "Mercer Tshirt", brand: "Salty", type: "tops", price: "LE 600", img: "/47.jpg", colors: ["#0c361dff"], sizes: ["S", "M", "L", "XL"], rating: 4.5, reviews: 167, desc: "Crafted from a textured, breathable fabric." },
  { id: 48, tab: "trend", gender: "unisex", name: "Ocean Swim Tshirt", brand: "Salty", type: "tops", price: "LE 600", img: "/48.jpg", imgs: ["/saltychart2.jpg"], colors: ["#28479cff"], sizes: ["S", "M", "L", "XL"], rating: 4.5, reviews: 167, desc: "The Ocean Swim T-Shirt, inspired by long days under the sun." },
  { id: 49, tab: "trend", gender: "women", name: "Chilli Babytee", brand: "Salty", type: "tops", price: "LE 300", img: "/49.jpg", colors: ["#28479cff"], sizes: ["S", "M", "L", "XL"], rating: 4.5, reviews: 167, desc: "Crafted from soft stretch fabric." },
  { id: 50, tab: "trend", gender: "men", name: "Origin Tshirt", brand: "Salty", type: "tops", price: "LE 500", img: "/50.jpg", colors: ["#9398a5ff"], sizes: ["S", "M", "L", "XL"], rating: 4.5, reviews: 167, desc: "The Origin T-Shirt, a clean oversized silhouette." },
