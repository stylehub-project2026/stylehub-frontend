...
function SilhouettePreview({ selectedTop, selectedBottom, body }) {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // 🎛  GARMENT WIDTH — affects BOTH top and bottom at the same time
  //     68 = base width as % of the stage. Increase → wider, decrease → narrower
  //     Example: change 68 → 80 to make all clothes wider overall
  // ─────────────────────────────────────────────────────────────────────────
